...
public class Commande {
	...
	private static final String CMD_OVERWRITE_FILES = "copie";
	...
	private void createExtractionOptionGroup() {
		...
		Option copie = new Option("C", CMD_OVERWRITE_FILES, false, "créer un copie de l'extraction si un fichier existe déjà avec ce nom");
	...
	public void parseArguments(String[] argument) {
		...
		if (cmd.hasOption(CMD_OVERWRITE_FILES)) {
			mustCopyFiles = true;
		}
